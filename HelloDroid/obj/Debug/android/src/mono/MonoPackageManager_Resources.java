...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "HelloDroid.dll" comes first in this list. */
		"HelloDroid.dll",
		"DryIoc.dll",
		"FFImageLoading.dll",
		...
		"Hello.dll",
		"Newtonsoft.Json.dll",
		"Softeq.XToolkit.Bindings.dll",
		"Softeq.XToolkit.Bindings.Droid.dll",
		"Softeq.XToolkit.Common.dll",
		"Softeq.XToolkit.Common.Droid.dll",
		"Softeq.XToolkit.WhiteLabel.dll",
		"Softeq.XToolkit.WhiteLabel.Droid.dll",
