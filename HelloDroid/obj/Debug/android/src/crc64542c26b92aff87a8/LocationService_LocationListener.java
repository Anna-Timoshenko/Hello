...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Softeq.XToolkit.WhiteLabel.Droid.Services.LocationService+LocationListener, Softeq.XToolkit.WhiteLabel.Droid", LocationService_LocationListener.class, __md_methods);
	}
	...
	public LocationService_LocationListener ()
	{
		...
		if (getClass () == LocationService_LocationListener.class)
			mono.android.TypeManager.Activate ("Softeq.XToolkit.WhiteLabel.Droid.Services.LocationService+LocationListener, Softeq.XToolkit.WhiteLabel.Droid", "", this, new java.lang.Object[] {  });
	}
